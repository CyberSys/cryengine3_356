...
CRecordingSystem::CRecordingSystem()
	...
	, m_bulletEffectName("")
	, m_trackerEffect1(NULL)
	, m_trackerEffect2(NULL)
	, m_trackerEffect3(NULL)
...
void CRecordingSystem::OnGameRulesInit()
{
	...
	m_trackerEffect1 = gEnv->pParticleManager->FindEffect("perk_fx.tracker.teir1");
	m_trackerEffect2 = gEnv->pParticleManager->FindEffect("perk_fx.tracker.teir2");
	m_trackerEffect3 = gEnv->pParticleManager->FindEffect("perk_fx.tracker.teir3");
